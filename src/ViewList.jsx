...
var TabPanel = React.createClass({
    ...
    viewDeleted: function (key) {
        ...
        // TODO: race condition here because of events, this is a hack
        ...
        var navs = this.state.tabs.map(function (tabs, i) {
            ...
            return (
                    ...
                    {tabs.map(function(x, j) {
                        var tab = this.props.views.get(x);
                        if (!tab) { tab = { title: "closed"}; }
...
var ViewList = Stapes.subclass({
    constructor: function (mount) {
        this.node = React.render(<TabPanel views={this} />, mount);
    },
